...
import com.lumagaizen.opcodewriter.opcodes.OpCode;
import com.lumagaizen.opcodewriter.opcodes.OpCodeContainer;
...
//------------------------------------------------------------------------------
    System.out.println(container.getOpNameStrings());
		...
		for(OpCode code : codes){
			System.out.println(code.getSpecificity()+"\t"+code.getFormat()+"\t"+code.getBranchLabel()+"\t"+code.getVariablesPattern()+"\t"+code.getEaPatternSubRoutine());
			System.out.println(code.getBranchLabel());
		}
//		
